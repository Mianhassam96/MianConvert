  ...
  return (
    <div className="space-y-4">
      ...
      <div className="glass-card overflow-hidden">
        {/* Panel header */}
        <div className="bg-gradient-to-r from-gray-50/80 to-white/80 dark:from-gray-800/60 dark:to-gray-900/60 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800 px-5 py-3.5 flex items-center gap-3">
